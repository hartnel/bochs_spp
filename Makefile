...
CC = gcc
CXX = g++
CFLAGS = -g -O2 -D_FILE_OFFSET_BITS=64 -D_LARGE_FILES -pthread  $(X_CFLAGS) -I/usr/include/SDL2 -D_REENTRANT $(MCH_CFLAGS) $(FLA_FLAGS) -DBX_PLUGIN_PATH="\"${plugdir}\"" -DBX_SHARE_PATH='"$(sharedir)"'
CXXFLAGS = -g -O2 -D_FILE_OFFSET_BITS=64 -D_LARGE_FILES -pthread  $(X_CFLAGS) -I/usr/include/SDL2 -D_REENTRANT $(MCH_CFLAGS) $(FLA_FLAGS) -DBX_PLUGIN_PATH="\"${plugdir}\"" -DBX_SHARE_PATH='"$(sharedir)"'
...
GUI_LINK_OPTS_WX = 
GUI_LINK_OPTS =  $(GUI_LINK_OPTS_X) $(GUI_LINK_OPTS_SDL2) $(GUI_LINK_OPTS_RFB) $(GUI_LINK_OPTS_TERM)
DEVICE_LINK_OPTS = 
RANLIB = ranlib
...
all: bochs bochs_plugins bximage  bxhub 



bochs: iodev/libiodev.a    iodev/network/libnetwork.a iodev/sound/libsound.a \
	...
	$(LIBTOOL) --mode=link --tag CXX $(CXX) -o $@ $(CXXFLAGS) $(LDFLAGS) -export-dynamic $(BX_OBJS) $(SIMX86_OBJS) \
		iodev/libiodev.a    iodev/network/libnetwork.a iodev/sound/libsound.a \
...
.win32_dll_plugin_target: iodev/libiodev.a    iodev/network/libnetwork.a \
...
install_unix: install_bin install_libtool_plugins install_man install_share install_doc 
